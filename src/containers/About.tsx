...
export default function About() {
  return (
    <div
      className="flex flex-col lg:flex-row justify-center items-center p-10 h-screen"
      id="about"
    >
      ...
      <div className="flex justify-center items-center text-left max-w-[600px] text-md lg:text-xl">
        <p>
          A Digilock é uma empresa especializada em serviços de digitalização e
          guarda de documentos com armazenamento em nuvem. Oferecemos suluções
          personalizadas para empresas de todos os portes e segmentos em geral.
          <br />
          <br />
          ...
          ajudar nossos clientes a gerenciar seus documentos de forma prática e
          eficiente, reduzindo seus custos e aumentando sua segurança.
        </p>
      </div>
    </div>
  );
