    ...
    >
      ...
      <div className="flex justify-center items-center text-left max-w-[600px] text-md lg:text-xl mt-10 lg:mt-0">
        <p>
          ...
          documentos que recebemos. Todos os documentos são tratados com sigilo
          absoluto e com contrato de prestação de serviços entre as partes,
          garantindo total proteção dos seus documentos e seguindo as normas da
